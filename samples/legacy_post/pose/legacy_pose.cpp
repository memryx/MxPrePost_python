...
// Model file paths
fs::path modelPath = "models/yolo/YOLO_v8_nano_pose_640_640_3_onnx.dfp";                      // Default model path
fs::path onnx_postprocessing_model_path = "models/yolo/YOLO_v8_nano_pose_640_640_3_onnx_post.onnx"; // Default post-processing model path
